...
//	private String bucketName="bitcamp-lsm";//각자 자기의 버켓명 나의 스토리지 
	...
	public String upload(Model model, @RequestParam MultipartFile upload) {
		...
		// 150*150
		String photo150 = "https://fr2k01411649.edge.naverncp.com/82uyvvqSQa/photo/" + fileName
				+ "?type=f&w=150&h=150&faceopt=true&ttype=jpg";
		// 80*80
		String photo80 = "https://fr2k01411649.edge.naverncp.com/82uyvvqSQa/photo/" + fileName
				+ "?type=f&w=80&h=80&faceopt=true&ttype=jpg";
