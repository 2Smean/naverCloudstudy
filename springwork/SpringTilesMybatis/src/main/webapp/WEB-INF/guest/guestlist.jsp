...
<div>
	...
	<c:forEach var="dto" items="${glist}">
		<div class="guest_box">
			...
			<img src="https://x4okas4n1726.edge.naverncp.com/66N4rPWy1d/guest/${dto.guest_photo}?type=f&w=100&h=100&faceopt=true&ttype=jpg" 
			class="img-thumbanail smallphoto" style="float: left;margin-right: 10px;cursor: pointer;"
			photoname="${dto.guest_photo}" data-bs-toggle="modal" data-bs-target="#myPhotoModal"
			title="원본 사진을 보려면 클릭하세요">
...
<script type="text/javascript">
	$("img.smallphoto").click(function () {
		...
		//모달 다이얼로그에 사진 넣기 
		$("img.largephoto").attr("src",`https://kr.object.ncloudstorage.com/guest-lsm/guest/\${photoname}`);
	});
</script>
</body>
</html>
