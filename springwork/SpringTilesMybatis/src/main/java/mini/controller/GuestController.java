...
public class GuestController {
	...
	private String bucketName="guest-lsm";
	private String folderName="guest";
	
	//번역 후 반환하는 메서드
	public String translate(String text1,String nara)
	{
		String clientId = "5yx3ffxca1";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "Px7loKUSeRtaqS0lq3YdPxvFMOdLw1YmLFTgjTsn";//애플리케이션 클라이언트 시크릿값";
        String returnValue="";
	...
	public String login(Model model,@RequestParam(defaultValue = "en") String nara)//nara: 기본 번역 언어는 영어
	{
	...
	//MultipartFile 에 있으면 무조건 post 로 해야함 
	...
	@ResponseBody public String getVoice(String message,String lang,HttpServletRequest request)
	{
		...
		String returnValue="";
		 ...
		 String clientId = "su6yu2k68s";//애플리케이션 클라이언트 아이디값";
	        String clientSecret = "o7Bn4QzcIhYHYGX7XPwNlAhyUpunn4hkTrj6s4Nq";//애플리케이션 클라이언트 시크릿값";
	        try {
