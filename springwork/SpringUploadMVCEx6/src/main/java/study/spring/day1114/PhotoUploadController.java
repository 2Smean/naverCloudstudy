...
public class PhotoUploadController {
	...
	public String upload3(@ModelAttribute("mdto") MemberDto dto, @RequestParam MultipartFile upload,
			@RequestParam MultipartFile upload2, HttpServletRequest request) {
		// 업로드할 프로젝트내의 경로 구하기
		String path = request.getSession().getServletContext().getRealPath("/WEB-INF/photo");
		System.out.println(path);
		// 파일명을 dto 에 저장
