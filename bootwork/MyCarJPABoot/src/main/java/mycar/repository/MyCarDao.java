...
public class MyCarDao {
	...
	//JpaREpository 를 상속 받을 경우 기본적인 SQL을 실행해주는 각종 메서드 호출 가능
...
//		return daoInter.getTotalMyCount;
	}
	
	//db 저장 
	public void insertMyCar(MyCarDto dto)
	{
		daoInter.save(dto); //save 는 dto 에 num 값이 포함되어있으면 update, 없으면 insert 를 실행한다.
	}
...
//		return daoInter.findAll(Sort.by(Sort.Direction.ASC, "carprice")); //가격이 싼거 부터 출력
	}
	...
	{
		daoInter.save(dto); // dto 에 num이 포함되어 있으므로 수정된다.
	}
