...
//interface 는 기능 구현을 할 메서드들의 목록을 나열해놓는 일을 한다
//interface 에는 상수와 추상메서드만 구현이 가능하다
// 그래서 구분을 할 필요가 없기 때문에 final,abstract 단어는 안쓴다 
//어차피 백프로 상수와 추상 메서드로만 구성이 되어있기 때문
//interface 도 new 로 생성할 수 없다
...
// 오류나서 빨간줄 쳐진 클래스명에서 Ctrl +1 로 옵션확인
...
public class Ex5_Interface {
	...
	public static void main(String[] args) {
		...
		a.play();
		a.study();
		//a.processNy();//오류발생-오버라이드 메서드가 아니므로 My로 선언시에만 호출가능
		System.out.println("---------");
		My b=new My();
		b.play();
		b.study();
