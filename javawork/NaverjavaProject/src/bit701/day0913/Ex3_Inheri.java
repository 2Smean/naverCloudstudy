...
// 2. abstract(추상) 클래스는 new 로 객체 생성을 할 수 없다
...
//	public void draw()
//	{
//		//부모 클래스가 하는일이 없으므로 안에 내용도 없음. 오로지 오버라이딩을 위해서 필요
//	}
	//오버라이드를 위해서 {} 부분을 없앤다
	//abstract: 추상화- 미완성적인 메서드라는 의미
	//class 의 멤버메서드중 한개이상의 추상 메소드가 있는경우
	//반드시 클래스도 추상화시켜야한다 . 즉 class 앞에 abstract 를 붙인다  추상화는 쉽게 말하면 미완성된 메서드 이다
