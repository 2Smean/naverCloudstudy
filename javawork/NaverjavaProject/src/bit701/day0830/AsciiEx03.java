...
public class AsciiEx03 {
	...
	public static void main(String[] args) {
		...
		System.out.println((int)a1);//65 아스키 코드값으로 출력하고 싶은겨우
		...
		System.out.println(b1+2);//묵시적 형 변환에 의해서 char+int=int, 그러므로 E 가 아니라 69가 나온다
		/*
		...
		System.out.println((char)(b1+2));//b1+2=69 로 int 타입인데 char 로 강제 형 변환해서 출력
		...
		System.out.println((double)(5/2));// int + int = int 결과를 double 로 형 변환해도 2.0이 될 뿐이다.
		// println이 대표적인 중복함수임
	}
