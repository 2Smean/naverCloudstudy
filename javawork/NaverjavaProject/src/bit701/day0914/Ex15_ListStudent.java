...
public class Ex15_ListStudent {
	...
	public int getMenu()
	{
		...
		try {
			...
			num=4;//번호에 문자가 들어간경우 4번. 전체출력으로 하기
		}
		return num;
	}
	...
	public void addStudent()
	{
		...
		//list에 추가
		list.add(s);
		System.out.println(list.size()+"번쨰 학생정보 추가됨!!");
	}
	...
	public void listStudent()
	{
		...
		//번호 이름 점수 형액형 순으로 출력 (단 혈액형은 대문자로 변환해서 출력)
