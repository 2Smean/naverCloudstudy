...
<label>
	...
	<select class="form-select" style="width: 120px">
		...
		<option value="../jquery/m02.jpg">바다#1</option>
		<option value="../jquery/m02.jpg">계곡</option>
		<option value="../jquery/m02.jpg">호수</option>
		<option value="../jquery/m02.jpg">바다#2</option>
	</select>
	<br>
	<h5>날짜를 선택해주세요</h5>
